...
**CATUNES** es un reproductor de música local para Android diseñado con las directrices de **Material Design 3** y un completo motor de audio impulsado por **Media3/ExoPlayer**.

---

## ✨ Características (Ya Implementadas)

- 📂 **Acceso por Carpetas (SAF)**: Añade y gestiona múltiples carpetas de música (incluyendo tarjetas SD externas) sin darle acceso completo a todo el almacenamiento interno.
- 🔍 **Buscador con Chips**: Filtra tu biblioteca de forma instantánea por **Canción, Artista o Álbum**.
...
- 💫 **MiniPlayer**: Barra inferior flotante con transiciones optimizadas y gestos dinámicos, visible a lo largo de toda la navegación.
...
Este proyecto está licenciado bajo la **CATUNES Open Source Non-Commercial License (COSNCL) v1.0**.

Consulta el archivo [LICENSE](LICENSE) para más detalles. Pero en resumen:
* **Uso no comercial**: Puedes usar, estudiar, modificar, hacer fork y redistribuir el software libremente siempre que sea para fines no comerciales.
* **Atribución requerida**: Debes incluir créditos claros a **Oron_8** en cualquier copia o derivado.
